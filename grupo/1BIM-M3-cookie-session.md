...
| Alunos(as) | Função |
| ------ | ------ |
| [Alice Gimenez Siqueira](https://github.com/alice-gimenez) | Estrutura do Relatório e Exercício 1 |
| [Alice Rasmussen Rezende Alves](https://github.com/alicerez0703) | Estrutura do Relatório e Exercício 1 |
...
| [Isabelli Dias da Silva](https://github.com/isabelbelli) | Estrutura do Relatório e Exercício 4 |
...
Já em relação aos **possíveis riscos ao utilizar apenas cookies**, isso acontece porque os dados ficam armazenados no dispositivo do usuário. Assim, eles podem ser modificados, ou roubados, tendo também limite de tamanho.
